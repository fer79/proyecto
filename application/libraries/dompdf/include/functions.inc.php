 ...
 * @param string $url        	
 * @return string Initially the trailing slash of $base_path was optional, and conditionally appended.
...
function build_url($protocol, $host, $base_path, $url) {
	...
	if (! in_array ( mb_strtolower ( $protocol ), array (
			"http://",
			"https://",
			"ftp://",
			"ftps://" 
