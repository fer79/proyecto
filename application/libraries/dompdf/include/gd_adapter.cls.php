...
class GD_Adapter implements Canvas {
	 ...
	 * Allocate with GD as needed and store
	...
	function text($x, $y, $text, $font, $size, $color = array(0,0,0), $word_spacing = 0.0, $char_spacing = 0.0, $angle = 0.0) {
		...
		$text = mb_encode_numericentity ( $text, array (
				0x0080,
				0xff,
				0,
				0xff 
	 ...
	 *        	the name of the image file (ignored)
	 * @param array $options
	 *        	associative array, 'type' => jpeg|jpg|png, 'quality' => 0 - 100 (jpeg only)
	 */
