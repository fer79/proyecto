...
class List_Bullet_Image_Frame_Decorator extends Frame_Decorator {
	 ...
	 *
	 * @param Frame $frame
	 *        	the bullet frame to decorate
	 * @param DOMPDF $dompdf
	 *        	the document's dompdf object
	 */
	...
	function get_width() {
		...
		// return $this->_width;
		return $this->_frame->get_style ()->get_font_size () * List_Bullet_Frame_Decorator::BULLET_SIZE + 2 * List_Bullet_Frame_Decorator::BULLET_PADDING;
	}
