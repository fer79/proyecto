...
class Page_Frame_Decorator extends Frame_Decorator {
	...
	/**
	 * Set the frame's containing block.
	 * Overridden to set $this->_bottom_page_margin.
	 *
	 * @param float $x        	
	 * @param float $y        	
	 * @param float $w        	
	...
	/**
	 * Check if a forced page break is required before $frame.
	 * This uses the
	...
	/**
	 * Check if $frame will fit on the page.
