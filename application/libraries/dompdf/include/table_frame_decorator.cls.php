...
class Table_Frame_Decorator extends Frame_Decorator {
	...
	/**
	 * The Cellmap object for this table.
	 * The cellmap maps table cells
	...
	/**
	 * Table header rows.
	 * Each table header is duplicated when a table
	 * spans pages.
	 *
	 * @var array
	 */
	...
	/**
	 * Table footer rows.
	 * Each table footer is duplicated when a table
	 * spans pages.
	 *
	 * @var array
	 */
	...
	/**
	 * split the table at $row.
	 * $row and all subsequent rows will be
