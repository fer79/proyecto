(function(b, c) {
    var a = function(f, e) {
        ...
        this.$element.on("click", ".wizard-steps li", b.proxy(this.stepclicked, this))
         var j = this.$element.find("li");
            j.addClass("active").addClass("complete");
    };
    a.prototype = {
        constructor: a,
        setState: function() {
            ...
            var j = this.$element.find("li");
            j.addClass("active").addClass("complete");
            j.find("span.badge").addClass("badge-info").addClass("badge-success");
        ...
        stepclicked: function(h) {
            ...
            var g = b(".wizard-steps li").index(d);
