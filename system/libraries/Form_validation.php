...
class CI_Form_validation {
	...
	protected $_custom_field_errors = array ();
	/**
	 * Constructor
	 */
	 ...
	 * @return mixed
	 */
	public function add_custom_error($field = '', $error_message = '') {
		if ($field == '') {
			return '';
		}
		$this->_custom_field_errors [$field] = $error_message;
	...
	function run($group = '') {
		...
		if (count ( $this->_custom_field_errors ) > 0) {
			foreach ( $this->_custom_field_errors as $field => $error_message ) {
